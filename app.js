...
(() => {
  ...
  function populateShopDropdown(filter = '') {
    ...
    const shops = filter ? filterShopsBySearchTerm(shopsData.shops, filter) : shopsData.shops;
      ...
      (error) => {
        ...
        switch (error.code) {
          case error.PERMISSION_DENIED:
            message =
              'Location access denied. Please enable location permissions or enter an address.';
